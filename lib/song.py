...
# Adding more songs
another_song = Song("Shape of You", "Ed Sheeran", "Pop")
yet_another_song = Song("HUMBLE.", "Kendrick Lamar", "Rap")

print(Song.count)  # 3
print(Song.genres)  # ["Rap", "Pop"]
print(Song.artists)  # ["Jay-Z", "Ed Sheeran", "Kendrick Lamar"]
print(Song.genre_count)  # {"Rap": 2, "Pop": 1}
print(Song.artist_count)  # {"Jay-Z": 1, "Ed Sheeran": 1, "Kendrick Lamar": 1}
